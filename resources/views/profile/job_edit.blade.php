...
<body>
    <div class="w-8/12 mx-auto  mt-20">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
            action="/profile/{{ $user->id }}/edit/job/{{ $job->id }}" method="POST"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="JobTitle" type="text" placeholder="JobTitle" name="JobTitle" value="{{ $job->JobTitle }}">
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="Field" type="text" placeholder="Field" name="Field" value="{{ $job->Field }}">
                </div>
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="Type" type="text" placeholder="Type" name="type" value="{{ $job->type }}">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        name="Requirements" id="Requirements" rows="4">{{ $job->Requirements }}</textarea>
                </div>
                <div class="mb-4">
                    ...
                    <textarea
                        class="form-textarea mt-1 block w-full shadow appearance-none border rounded text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        name="Description" id="Description" rows="4">{{ $job->Description }}</textarea>
                </div>
            </div>
