...
<form action="/action_page.php" style="border:1px solid #ccc">
  <div class="container">
    ...
    <table border="0" cellpadding="5" cellspacing="0">
        <tr> 
            <td style="width: 50%">
                <label for="fname"><b>Fisrt Name:</b></label><br />
                <input name="fname" type="text" maxlength="50" style="width:100%;max-width: 260px" placeholder="Enter your First Name" required>
            </td> 
            <td>&nbsp;&nbsp;</td>
            <td style="width: 60%">
                <label for="lname"><b>Last Name:</b></label><br />
                <input name="lname" type="text" maxlength="50" style="width:100%;max-width: 260px" placeholder="Enter your Last Name" required>
            </td>  
        </tr> 
        ...
        <tr>
            ...
            <input type="text" maxlength="150" style="width:100%;max-width: 535px" placeholder="Enter Email" name="email" required> 
            </td>
        </tr>
