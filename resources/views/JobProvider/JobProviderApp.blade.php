...
<body>
    ...
    <form action="/action_page.php" style="border:1px solid #ccc">
        ...
        <div class="container">
            ...
            <input type="text" maxlength="150" style="width:100%;" placeholder="Enter Company Field" name="companyfield"
                required>

            <label for="companytitle"><b>Company Title</b></label><br>
            <input type="text" maxlength="150" style="width:100%;" placeholder="Enter Company Title" name="companytitle"
                required>
